...
blueprint_t entity_blueprint_hero = {
            ...
            { 103, METADATA, 1, FALLING_DOWN, 410  }, // len + which anim
              ...
              { 312, MAP   , 0, 2, 350  },
                { 330,                                0,  0, 0,  0 },
                { 330 + ANIMATION_COMPONENT_OUTLINE, 25,154,15, 19 },
                { 330 + ANIMATION_COMPONENT_HITBOX,   0,  0,15, 19 },
                { 330 + ANIMATION_COMPONENT_GRIP,     9, 10, 0, 10 },
                { 330 + ANIMATION_COMPONENT_HANDLE,   9, 10, 0, 10 },
                { 330 + ANIMATION_COMPONENT_DELAY,    0,  0, 0,  1 },
                { 340,                                0,  0, 0,  0 },
                { 340 + ANIMATION_COMPONENT_OUTLINE,  4,154,15, 19 },
                { 340 + ANIMATION_COMPONENT_HITBOX,   0,  0,15, 19 },
                { 340 + ANIMATION_COMPONENT_GRIP,     9, 10, 0, 10 },
                { 340 + ANIMATION_COMPONENT_HANDLE,   9, 10, 0, 10 },
                { 340 + ANIMATION_COMPONENT_DELAY,    0,  0, 0,  3 },
                { 350,                                0,  0, 0,  0 },
                { 350 + ANIMATION_COMPONENT_OUTLINE, 24,154,15, 19 },
                { 350 + ANIMATION_COMPONENT_HITBOX,   0,  0,15, 19 },
              ...
              { 410, MAP   , 0, 0, 430  }, // map to frames
                { 430,                               0,  0, 0,  0 },
                { 430 + ANIMATION_COMPONENT_OUTLINE, 4,215,15, 19 },
                { 430 + ANIMATION_COMPONENT_HITBOX,  0,  0,15, 19 },
