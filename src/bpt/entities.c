...
blueprint_t entity_blueprint_hero = {
            ...
            { 40 + ENTITY_COMPONENT_MOVE_POWUH   ,     DEFAULT, 0, 0,       SUBPIX * 2 },
            { 40 + ENTITY_COMPONENT_X_FRICTION   ,     DEFAULT, 0, 0,                8 },
            { 40 + ENTITY_COMPONENT_AIR_X_FRICTION,    DEFAULT, 0, 0,                2 },
            { 40 + ENTITY_COMPONENT_MAX_X_VEL   ,      DEFAULT, 0, 0,       SUBPIX * 8 },
            { 40 + ENTITY_COMPONENT_MAX_Y_VEL   ,      DEFAULT, 0, 0,                8 },
            { 40 + ENTITY_COMPONENT_STATE_DES   ,      DEFAULT, 0, 0,                0 },
            { 100, METADATA, 4, IDLE,         110  },
            { 101, METADATA, 6, WALKING,      210  },
            { 102, METADATA, 1, JUMPING,      310  },// TODO: back to three anotmation frames
            ...
            { 1500, MAP, 0, IDLE,         1510  }, 
              { 1510, METADATA, 5, PHASE_PRE,       1520  },
              { 1511, METADATA, 4, PHASE_INIT,      1530  },
              { 1512, METADATA, 3, PHASE_UPDATE,    1540  },
              { 1513, METADATA, 4, PHASE_CONTROL,   1550  },
              { 1514, METADATA, 1, PHASE_COLLISION, 1560  },
              { 1515, METADATA, 5, PHASE_RESOLVE,   1570  },
              { 1516, METADATA, 1, PHASE_DRAW,      1580  },
                { 1520, BEHAVIOUR, PHASE_PRE, 0, BEHAVIOUR_SET_CAMERA      },
                { 1521, BEHAVIOUR, PHASE_PRE, 1, BEHAVIOUR_ADD_FRAME_TIMER },
                { 1522, BEHAVIOUR, PHASE_PRE, 2, BEHAVIOUR_CATCH_POS       },
                { 1523, BEHAVIOUR, PHASE_PRE, 3, BEHAVIOUR_SET_FOCUS       },
                { 1524, BEHAVIOUR, PHASE_PRE, 4, BEHVIOUR_CATCH_STATE      },
                { 1530, BEHAVIOUR, PHASE_INIT, 0, BEHAVIOUR_SET_DEFAULTS   },
                { 1531, BEHAVIOUR, PHASE_INIT, 1, BEHAVIOUR_SET_FRAME      },
                { 1532, BEHAVIOUR, PHASE_INIT, 2, BEHAVIOUR_SET_HITBOX     },
                { 1533, BEHAVIOUR, PHASE_INIT, 3, BEHAVIOUR_BLOCK_INIT     },
                ...
                { 1572, BEHAVIOUR, PHASE_RESOLVE, 2, BEHAVIOUR_ANIM_FRAME       },
                { 1573, BEHAVIOUR, PHASE_RESOLVE, 3, BEHAVIOUR_UPDATE_SECTOR   },
                { 1574, BEHAVIOUR, PHASE_RESOLVE, 4, BEHVIOUR_UPDATE_STATE   },
                { 1580, BEHAVIOUR, PHASE_DRAW, 0, BEHAVIOUR_DRAW_SPRITE   },
            { 1501, MAP, 0, WALKING,      1610  }, 
              { 1610, METADATA, 5, PHASE_PRE,       1620  },
              ...
              { 1616, METADATA, 1, PHASE_DRAW,      1670  },
                ...
                { 1623, BEHAVIOUR, PHASE_PRE, 3, BEHAVIOUR_SET_FOCUS       },
                { 1624, BEHAVIOUR, PHASE_PRE, 4, BEHVIOUR_CATCH_STATE      },
                ...
                { 1661, BEHAVIOUR, PHASE_RESOLVE, 1, BEHAVIOUR_ANIM_FRAME      },
                { 1662, BEHAVIOUR, PHASE_RESOLVE, 2, BEHAVIOUR_UPDATE_SECTOR   },
                { 1663, BEHAVIOUR, PHASE_RESOLVE, 3, BEHVIOUR_UPDATE_STATE   },
                { 1670, BEHAVIOUR, PHASE_DRAW, 0, BEHAVIOUR_DRAW_SPRITE   },
            { 1502, MAP, 0, JUMPING,      1710  }, 
              { 1710, METADATA, 6, PHASE_PRE,       1720  },
              { 1712, METADATA, 3, PHASE_UPDATE,    1730  },
              { 1713, METADATA, 3, PHASE_CONTROL,   1740  },
              { 1714, METADATA, 1, PHASE_COLLISION, 1750  },
              { 1715, METADATA, 4, PHASE_RESOLVE,   1760  },
              { 1716, METADATA, 1, PHASE_DRAW,      1770  },
                { 1720, BEHAVIOUR, PHASE_PRE, 0, BEHAVIOUR_ADD_FRAME_TIMER },
                { 1721, BEHAVIOUR, PHASE_PRE, 1, BEHAVIOUR_CATCH_POS       },
                { 1722, BEHAVIOUR, PHASE_PRE, 2, BEHAVIOUR_UPDATE_SECTOR   },
                { 1723, BEHAVIOUR, PHASE_PRE, 3, BEHAVIOUR_SET_FOCUS       },
                { 1724, BEHAVIOUR, PHASE_PRE, 4, BEHAVIOUR_SET_CAMERA      },
                { 1725, BEHAVIOUR, PHASE_PRE, 5, BEHVIOUR_CATCH_STATE      },
            ...
            { 1503, MAP, 0, FALLING_DOWN, 1810  }, 
              ...
              { 1816, METADATA, 1, PHASE_DRAW,      1870  },
                ...
                { 1823, BEHAVIOUR, PHASE_PRE, 3, BEHAVIOUR_SET_FOCUS       },
                { 1824, BEHAVIOUR, PHASE_PRE, 4, BEHVIOUR_CATCH_STATE      },
                ...
                { 1862, BEHAVIOUR, PHASE_RESOLVE, 2, BEHAVIOUR_ANIM_FRAME      },
                { 1863, BEHAVIOUR, PHASE_RESOLVE, 3, BEHAVIOUR_UPDATE_SECTOR        },
                { 1864, BEHAVIOUR, PHASE_RESOLVE, 4, BEHVIOUR_UPDATE_STATE   },
                { 1870, BEHAVIOUR, PHASE_DRAW, 0, BEHAVIOUR_DRAW_SPRITE   },
            { 1504, MAP, 0, PREJUMP,      1910  }, 
              { 1910, METADATA, 4, PHASE_PRE,       1920  },
              ...
              { 1916, METADATA, 1, PHASE_DRAW,      1970  },
                ...
                { 1923, BEHAVIOUR, PHASE_PRE, 3, BEHAVIOUR_SET_FOCUS       },
                ...
                { 1961, BEHAVIOUR, PHASE_RESOLVE, 1, BEHAVIOUR_ANIM_FRAME      },
                { 1962, BEHAVIOUR, PHASE_RESOLVE, 2, BEHAVIOUR_UPDATE_SECTOR   },
                { 1963, BEHAVIOUR, PHASE_RESOLVE, 3, BEHVIOUR_UPDATE_STATE   },
...
blueprint_t entity_blueprint_tile = {
        ...
        { 500, MAP, 0, IDLE,         510  }, 
          { 511, METADATA, 2, PHASE_INIT,      520  },
          { 516, METADATA, 1, PHASE_DRAW,      580  },
