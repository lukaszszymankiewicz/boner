...
blueprint_t entity_blueprint_hero = {
            ...
            { 103, METADATA, 1, FALLING_DOWN, 410  }, // len + which anim
              ...
              { 312, MAP   , 0, 2, 350  },
                { 330,                                0,  0, 0,  0 },
                { 330 + ANIMATION_COMPONENT_OUTLINE, 50,308,30, 38 },
                { 330 + ANIMATION_COMPONENT_HITBOX,   0,  0,30, 38 },
                { 330 + ANIMATION_COMPONENT_GRIP,     9, 10, 0, 10 },
                { 330 + ANIMATION_COMPONENT_HANDLE,   9, 10, 0, 10 },
                { 330 + ANIMATION_COMPONENT_DELAY,    0,  0, 0,  1 },
                { 340,                                0,  0, 0,  0 },
                { 340 + ANIMATION_COMPONENT_OUTLINE,  8,308,30, 38 },
                { 340 + ANIMATION_COMPONENT_HITBOX,   0,  0,30, 38 },
                { 340 + ANIMATION_COMPONENT_GRIP,     9, 10, 0, 10 },
                { 340 + ANIMATION_COMPONENT_HANDLE,   9, 10, 0, 10 },
                { 340 + ANIMATION_COMPONENT_DELAY,    0,  0, 0,  3 },
                { 350,                                0,  0, 0,  0 },
                { 350 + ANIMATION_COMPONENT_OUTLINE, 48,308,30, 38 },
                { 350 + ANIMATION_COMPONENT_HITBOX,   0,  0,30, 38 },
              ...
              { 410, MAP   , 0, 0, 430  }, // map to frames
                { 430,                               0,  0, 0,  0 },
                { 430 + ANIMATION_COMPONENT_OUTLINE, 8,430,30, 38 },
                { 430 + ANIMATION_COMPONENT_HITBOX,  0,  0,30, 38 },
